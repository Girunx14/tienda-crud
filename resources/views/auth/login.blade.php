        ...
        <div class="col-md-5">
            <div class="glass-card border-0 p-5 shadow-lg animate__animated animate__zoomIn">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        <label for="email" class="form-label fw-bold small text-muted text-uppercase mb-2">Correo
                            Electrónico</label>
                        <div class="input-group border rounded-3 p-1 bg-white">
                            ...
                            <input id="email" type="email"
                                class="form-control border-0 shadow-none @error('email') is-invalid @enderror" name="email"
                    ...
                    <div class="mb-4">
                        <label for="password"
                            class="form-label fw-bold small text-muted text-uppercase mb-2">Contraseña</label>
                        <div class="input-group border rounded-3 p-1 bg-white">
                            <span class="input-group-text border-0 bg-transparent text-muted"><i
                        ...
                        @if (Route::has('register'))
                            <p class="text-center text-muted small mb-0">
                                ¿No tienes cuenta? <a href="{{ route('register') }}"
                                    class="text-primary fw-bold text-decoration-none">Regístrate gratis</a>
                            </p>
                        @endif
                    </div>
                </form>
